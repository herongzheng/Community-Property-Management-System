...
INSERT INTO post(id, posted_time, content, is_important, user_id, reply_to, likes)
values(4, "2023-08-25 12:21:23", "good 4 you", 0, "Room003", 3, 0);
INSERT INTO post(id, posted_time, content, is_important, user_id, reply_to, likes)
values(5, "2023-08-25 12:21:23", "What a great day!", 0, "Room005", null, 0);
...
INSERT INTO package(id, description, received_date, pickup_date, tenant_id)
values(5, "this is good", "2023-08-23", null, "Room001")

INSERT INTO package(id, description, received_date, pickup_date, tenant_id)
values(2, "good", "2023-08-21", "2023-08-22", "Room001")