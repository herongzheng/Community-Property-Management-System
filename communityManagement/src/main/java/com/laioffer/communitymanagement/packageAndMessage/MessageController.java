...
public class MessageController {
    ...
    @GetMapping("/messages/unpicked_count")
    public int countPackagesNotPickedUp(Principal principal) {
        return messageService.checkPackagesNotPickedUp(principal.getName());
    }
